...
class Plantation(models.Model):
    ...
    name = fields.Char('Identification plantation', readonly=True)
    ...
    @api.model
    def create(self, values):
        sector = self.env['sector.sector'].browse(values['sector_id'])
        values['name'] = sector.seq_id.next_by_id()
        return super(Plantation, self).create(values)
